...
class GameApp(EngineManagerMixin, PromotionMixin, DialogsMixin):
    ...
    def undo_move(self):
        ...
        self.captured_pieces = snap["captured_pieces"];
        self.game_result = None
        self._promotion_dialog = None
        self.search_info = {}
        self.selected_piece = None
    ...
    def execute_move(self, move):
        ...
        self._undo_stack.append(
            {
                ...
                "captured_pieces":{0: list(self.captured_pieces[0]), 1: list(self.captured_pieces[1])},
            }
        )
        ...
        target_piece = self.game_state.board[enemy][actual_tr][tc]
        if target_piece != 0:
            self.captured_pieces[mover].append(target_piece)
    ...
    def draw(self):
        ...
        self.board_renderer._draw_captured_pieces(self.captured_pieces)
